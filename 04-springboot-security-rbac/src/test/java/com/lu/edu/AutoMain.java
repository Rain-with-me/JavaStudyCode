...
//        设置全局配置
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/springsecurity?serverTimezone=UTC");
        ...
        strategy.setInclude("sec_user","sec_role_permission","sec_role","sec_permission"); // 设置要映射的表名
         //数据库表 映射到实体的命名策略
        strategy.setNaming(NamingStrategy.underline_to_camel);
        //数据库表字段 映射到实体的命名策略
        strategy.setColumnNaming(NamingStrategy.underline_to_camel);
        //生成实体时去掉表前缀
        strategy.setTablePrefix("sec_","sys_");
